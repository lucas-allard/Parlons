...
const settingUpdaters: {
  ...
  openrouter_cloud_api_key: (value) =>
    commands.changeOpenrouterCloudApiKeySetting((value as string | null) ?? ""),
  openrouter_cloud_model: (value) =>
    commands.changeOpenrouterCloudModelSetting(value as string),
};
